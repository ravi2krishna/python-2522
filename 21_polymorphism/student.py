...
class Student(Personable, Payables):
    ...
    def __init__(self, student_id=None, student_name=None, student_age=None, student_email=None, student_mobile_number=None):
        ...
        AbstractPerson.__init__(self,id=student_id,name=student_name,age=student_age,email=student_email,mobile_number=student_mobile_number)
